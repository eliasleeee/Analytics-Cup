...
def gain(attributes, data, attr, targetAttr):
    ...
    entropy_return = entropy(attributes, data, targetAttr) - subsetEntropy
...
def chooseAttr(data, attributes, target):
    ...
    maxGain = 0
    attributes_NoTarget = []
    attributes_NoTarget = attributes[:]
    attributes_NoTarget.remove(target)
    for attr in attributes_NoTarget:
